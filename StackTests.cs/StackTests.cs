...
namespace StackTest
{
    ...
    public class StackTest
    {
        ...
        public void Constructor_head_is_null_Test()
        {
            ...
            Assert.That(stack.GetHead(), Is.Null);
        }
        #endregion
        ...
        public void Push_Inserts_To_Head_Test()
        {
            ...
            Point headPoint = stack.GetHead().Element;
            Assert.That(headPoint, Is.EqualTo(newPoint));
            Assert.That(stack.GetHead().Previous, Is.Null);
        }
        ...
        public void Push_Inserts_To_Head_when_list_is_larger_Test()
        {
            ...
            Point headPoint = stack.GetHead().Element;
            Point bottomPoint = stack.GetHead().Previous.Element;
        ...
        public void Top_Throws_Exception_On_EmptyStack_Test()
        {
            ...
            Assert.That(() => stack.Top(), Throws.Exception.TypeOf<ApplicationException>());
        }
        /// <summary>
        ...
        public void Top_returns_head_in_larger_list_Test()
        {
            ...
            Point returnedPoint = stack.Top();
            Point headPoint = stack.GetHead().Element;
            Point secondPoint = stack.GetHead().Previous.Element;
            Point thirdPoint = stack.GetHead().Previous.Previous.Element;
            Node<Point> lastNode = stack.GetHead().Previous.Previous;
